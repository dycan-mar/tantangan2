...
<!-- hero -->
<section class="hero pt-3" id="hero">
    <div class="container p-5 mt-5 d-flex justify-align-center">
        <div class="container m-3 col-6">
            <h1 class="hidden scale-up text-light fs-1 fw-bold">
                Optimalkan manajemen usaha Anda bersama Kami
            </h1>
            <br>
            <p class="hidden scale-up text-light fw-medium">
                <span class="text-warning">Punya usaha tapi masih serba manual?</span> Wujudkan software impian anda
                untuk membantu mengatur
                usaha anda dengan optimal. Saatnya miliki aplikasi <em> custom</em> sesuai dengan kebutuhan usaha anda
                dan
                nikmati manajemen secara otomatis.
            </p>
            <div class="container-cta">
                <a class="hidden from-left m-3 btn btn-light" target="_blank"
                    ...
                    Kami</a>
                <a class="hidden from-right m-3 btn btn-transparant" href="<?= $baseurl ?>karir/">Lowongan</a>
            </div>
...
<section class="about mb-5 mt-5 pt-3 container d-flex justify-align-center" id="about">
    <div class="hidden from-bottom container col-6">
        ...
        <p class="mt-3" style="opacity: 50%">
            Tuban Web adalah penyedia jasa pembuatan website, aplikasi android dan desktop yang berpusat di Tuban - Jawa
            Timur. <br>
            Kami siap melayani segala kebutuhan digital anda terutama untuk aplikasi custom. Anda dapat mengkosultasikan
            kebutuhan digital anda pada kami secara gratis. Kami akan dengan senang hati melayani anda. Berikut adalah
        ...
        <div class="container d-flex align-items-center justify-align-center ">
            ...
            <a class="btn-sosmed me-3" target="_blank" href="https://www.instagram.com/tubanweb/">
                <svg xmlns=" http://www.w3.org/2000/svg" width="16" height="16" fill="#2124B1" class="bi bi-instagram"
                    viewBox="0 0 16 16">
                    <path
    ...
    <div class="hidden scale-up img col-6" style="text-align:center;">
        <img style="width:400px !important;" src="../assets/img/about.jpg" alt="">
    </div>
</section>
...
<section class="hidden from-bottom jasaPelayanan container mt-5" id="jasaDanPelayanan">
    <div class=" p-5 pt-5 d-block justify-align-center text-center">
        ...
        <div class=" mt-5 row d-flex justify-content-between text-center">
            <div class="hidden scale-up delay-1 container p-3 col-4 card-cw">
                <div class="text-center">
                    <img src="../assets/img/pembuatan-website.png" alt="">
                </div>
                <h5 class="fw-medium">Custom Web App</h5>
                <p class="">
                    Optimalkan usaha dengan Custom Web App seperti: Kelola Keuangan, Stok Gudang, Laporan Pekerjaan, dll
                </p>
            ...
            <div class="hidden scale-up delay-2 container p-3 col-4 card-cw">
                <div class="text-center">
            ...
            <div class="hidden scale-up delay-3 container p-3 col-4 card-cw">
                <div class="text-center">
                    <img src="../assets/img/aplikasi-android.png" alt="">
                </div>
                <h5 class="fw-medium">Aplikasi Android</h5>
                <p class="">
                    Butuh aplikasi android atau desktop dengan fitur yang sesuai kebutuhan anda? Kami siap mewujudkan...
                </p>
            ...
            <div class="hidden scale-up delay-4 container p-4 col-4 card-cw">
                <div class="text-center">
                    <img src="../assets/img/landing-page.png" alt="">
                </div>
                <h5 class="fw-medium">Aplikasi Desktop</h5>
                <p class="">
                    Buat anda yang menginginkan aplikasi yang hanya dapat diakses di komputer kantor, aplikasi desktop
                    solusinya.
                </p>
            ...
            <div class="hidden scale-up delay-5 container p-4 col-4 card-cw">
                <div class="text-center">
            ...
            <div class="hidden scale-up delay-6 container p-4 col-4 card-cw">
                <div class="text-center">
...
<section class="hidden from-bottom project" id="project">
    <div class="container">
        <div class="carousel-wrapper" id="carouselWrapper">
            <div id="carousel" class="card-container">
...
<section class=" question my-5 mt-5" id="question">
    <div class="container d-block">
        ...
        <!-- container-card -->
        <div class="container row " style="gap: 28px;">
            <!-- card -->
            <div class="hidden from-bottom px-3 card-question py-4 g-3 d-flex">
                <div>
            ...
            <div class="hidden from-bottom px-3 card-question py-4 g-3 d-flex" style="width: 100%;">
                <div>
                    <span class=" px-2 py-1 rounded-circle bg-dark">
                        <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="#ffffff"
                            class="bi bi-question-lg mb-1" viewBox="0 0 16 16">
                ...
                <div class="container">
                    ...
                    <div class="conttainer d-flex g-5">
                        ...
                        <a class="btn btn-primary btn-qs mx-3" target="_blank"
                            href="https://api.whatsapp.com/send/?phone=6281213404031&text=Halo+kak%2C+saya+ingin+konsultasi+terkait+Custom+Web+App+yang+cocok+untuk+usaha+saya.+Terimakasih+atas+tanggapannya.&type=phone_number&app_absent=0">
...
<script>
    ...
    function renderCards() {
        ...
        for (let i = 0; i < 3; i++) {
            ...
            card.innerHTML = `
                    <div class="card-body">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#ffffff" class="bi bi-quote" viewBox="0 0 16 16">
                            <path d="M12 12a1 1 0 0 0 1-1V8.558a1 1 0 0 0-1-1h-1.388q0-.527.062-1.054.093-.558.31-.992t.559-.683q.34-.279.868-.279V3q-.868 0-1.52.372a3.3 3.3 0 0 0-1.085.992 4.9 4.9 0 0 0-.62 1.458A7.7 7.7 0 0 0 9 7.558V11a1 1 0 0 0 1 1zm-6 0a1 1 0 0 0 1-1V8.558a1 1 0 0 0-1-1H4.612q0-.527.062-1.054.094-.558.31-.992.217-.434.559-.683.34-.279.868-.279V3q-.868 0-1.52.372a3.3 3.3 0 0 0-1.085.992 4.9 4.9 0 0 0-.62 1.458A7.7 7.7 0 0 0 3 7.558V11a1 1 0 0 0 1 1z"/>
                        </svg>
                        <p class="card-text fw-semibold">${item.text}</p>
                        <div class="d-flex justify-content-between">
                            <img class="img-project" src="../assets/img/${item.img}">
                            <div class="d-block">
                                <h5 class="card-title mt-3">${item.company}</h5>
