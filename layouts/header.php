...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-transparent justify-content-between position-fixed p-0 w-100"
        id="navbar">
        <div class="d-flex justify-content-between p-0" style="width: 100%;">
            <div class="navbar-brand p-0 m-3">
                <a class="navbar-brand" href="#">
                    <img id="logo" src="../assets/img/logo-light.png" alt="" width="100" height="55">
                </a>
            </div>
